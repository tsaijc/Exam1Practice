...
def run_test_problem3a():
    ...
    # Window 4:
    title = 'Problem 3a. Test 5: Start at (10,14), 25 lines'
    window4 = rg.RoseWindow(500, 500, title)

    # Test 5 (it is on window 4):
    point = rg.Point(10, 14)
    expected = 283
    answer = problem3a(window4, point, 25)
    print()
...
def problem3b(m, point1):
    ...
    total = 0
    for k in range(m):
        total = total + problem3a(window, point1.clone(), numberoflines)
